...
set "mod_name=Icewind Dale II Bonus Merchant"
set mod_version=Test_Build_1_for_v5
set mod_folder=merchant
...
set mod_readme=https://pocket-plane-group.github.io/readmes/readme-merchant.html
